...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_tasklist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('isTemplate', self.gf('django.db.models.fields.BooleanField')()),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'], null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['TaskList'])

        # Deleting field 'Task.project'
        db.delete_column(u'projects_task', 'project_id')

        # Adding field 'Task.tasklist'
        db.add_column(u'projects_task', 'tasklist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.TaskList']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TaskList'
        db.delete_table(u'projects_tasklist')

        # Adding field 'Task.project'
        db.add_column(u'projects_task', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Project']),
                      keep_default=False)

        # Deleting field 'Task.tasklist'
        db.delete_column(u'projects_task', 'tasklist_id')
    ...
    models = {
        ...
        u'projects.task': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'startDate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'tasklist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.TaskList']"})
        },
        u'projects.tasklist': {
            'Meta': {'object_name': 'TaskList'},
            'created': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isTemplate': ('django.db.models.fields.BooleanField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
